    ...
    <>
      <div className='min-h-screen bg-neutral-800 flex flex-col items-center justify-center text-center'>
        ...
        <a href="https://vite.dev" target="_blank">
          <img src={viteLogo} className="menambahkan class w-24 h-24" alt="Vite logo" />
        </a>
        <a href="https://react.dev" target="_blank">
          <img src={reactLogo} className="menambahkan class w-24 h-24 animate-spin" alt="React logo" style={{animationDuration : "10s"}} />
        </a>
      </div>
      <h1 className='text-white text-6xl font-bold mb-16'>Vite + React</h1>
      <h3 className='text-white'>Muhammad Syafan Midhad</h3>
